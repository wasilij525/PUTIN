...
This mechanism has been integrated into Bitcore-Node-putin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/putin-Project/insight-api-putin#web-socket-api](https://github.com/putin-Project/insight-api-putin#web-socket-api)
* API: [https://github.com/putin-Project/insight-api-putin#hypersend-transactions](https://github.com/putin-Project/insight-api-putin#hypersend-transactions)
...
By default, the putin Core daemon will launch using the following constant:

```
static const int DEFAULT_HYPERSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the putin Core daemon:
