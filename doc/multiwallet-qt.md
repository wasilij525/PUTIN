...
In order to support loading of multiple wallets in putin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is putin.cpp.
...
Changes to putin.cpp
----------------------
putin.cpp is the entry point into putin-qt, and as such, will require some minor modifications to provide hooks for
