...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* putin features */
        {"putin", "masternode", &masternode, true, true, false},
        {"putin", "listmasternodes", &listmasternodes, true, true, false},
        {"putin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"putin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"putin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"putin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"putin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"putin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"putin", "masternodedebug", &masternodedebug, true, true, false},
        {"putin", "startmasternode", &startmasternode, true, true, false},
        {"putin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"putin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"putin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"putin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"putin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"putin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"putin", "mnbudget", &mnbudget, true, true, false},
        {"putin", "preparebudget", &preparebudget, true, true, false},
        {"putin", "submitbudget", &submitbudget, true, true, false},
        {"putin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"putin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"putin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"putin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"putin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"putin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"putin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"putin", "checkbudgets", &checkbudgets, true, true, false},
        {"putin", "mnsync", &mnsync, true, true, false},
        {"putin", "spork", &spork, true, true, false},
        {"putin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzXPTNseed", &getzXPTNseed, false, false, true},
        {"zerocoin", "setzXPTNseed", &setzXPTNseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzXPTN", &searchdzXPTN, false, false, true},
        {"zerocoin", "dzXPTNstate", &dzXPTNstate, false, false, true}
...
{
    return "> putin-cli " + methodname + " " + args + "\n";
}
