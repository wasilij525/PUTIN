...
extern UniValue setzXPTNseed(const UniValue& params, bool fHelp);
extern UniValue getzXPTNseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzXPTN(const UniValue& params, bool fHelp);
extern UniValue dzXPTNstate(const UniValue& params, bool fHelp);
