                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzXPTNPathCustom = GetArg("-zXPTNbackuppath", "");
    ...
    if(!strzXPTNPathCustom.empty()) {
        ui->wallet_customzXPTNbackuppath->setText(QString::fromStdString(strzXPTNPathCustom));
        ui->wallet_customzXPTNbackuppath_label->setVisible(true);
        ui->wallet_customzXPTNbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzXPTNPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the putin RPC console.") + "<br>" +
