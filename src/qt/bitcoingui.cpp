                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("putin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a putin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and putin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zXPTN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About putin Core"), this);
    aboutAction->setStatusTip(tr("Show information about putin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for putin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your putin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified putin addresses"));
    ...
    openAction->setStatusTip(tr("Open a putin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the putin Core help message to get a list with possible putin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("putin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to putin network", "", count));
}
...
{
    QString strTitle = tr("putin Core"); // default title
