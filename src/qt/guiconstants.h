...
/* putin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "putin"
#define QAPP_ORG_DOMAIN "putin.org"
#define QAPP_APP_NAME_DEFAULT "putin-Qt"
#define QAPP_APP_NAME_TESTNET "putin-Qt-testnet"
