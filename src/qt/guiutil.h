...
/** Utility functions used by the putin Qt UI.
 */
namespace GUIUtil
{
...
// Render putin addresses in monospace font
...
// Parse "putin:" URI into recipient object, return true on successful parsing
