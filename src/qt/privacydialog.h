...
public:
    ...
    void setZXPTNControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzXPTN_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzXPTN_clicked();
    void on_pushButtonZXPTNControl_clicked();
