Contributing to putin Core
============================

The putin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the putin Core project, and is not to be
confused with overall putin Network Protocol consensus changes.

Whether a pull request is merged into putin Core rests with the project merge
...
Patches that change putin consensus rules are considerably more involved than
...
Where a patch set proposes to change the putin consensus, it must have been
...
The project leader is the release manager for each putin Core release.
