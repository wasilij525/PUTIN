...
RESOURCES += src/qt/putin.qrc src/qt/putin_locale.qrc

TRANSLATIONS += src/qt/locale/putin_bg.ts \
                src/qt/locale/putin_de.ts \
                src/qt/locale/putin_en.ts \
                src/qt/locale/putin_es.ts \
                src/qt/locale/putin_fi.ts \
                src/qt/locale/putin_fr.ts \
                src/qt/locale/putin_it.ts \
                src/qt/locale/putin_ja.ts \
                src/qt/locale/putin_pl.ts \
                src/qt/locale/putin_pt.ts \
                src/qt/locale/putin_ru.ts \
                src/qt/locale/putin_sk.ts \
                src/qt/locale/putin_sv.ts \
                src/qt/locale/putin_vi.ts \
                src/qt/locale/putin_zh_CN.ts \
                src/qt/locale/putin_zh_TW.ts
