...
#   c) node1 mines 32 blocks, so now node 0 has 60001XPTN, node 1 has 4250XPTN, node2 has none.
#   d) node0 sends 601 XPTN to node2, in two transactions (301 XPTN, then 300 XPTN).
